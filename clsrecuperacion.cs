using SendGrid.Helpers.Mail;// libreria utilizada para esto
using SendGrid;// libreria utilizada para enviar correos 
using System;
using System.Collections.Generic;
using System.Data.SqlClient;
using System.Data;
using System.Linq;
using System.Runtime.Caching;// para almacenar datos en el cache de memoria 
using System.Text;
...
namespace Proyecto_DesarrolloSoftware
{
    class clsrecuperacion: clsConexion
    {
        ...
        public bool ValidarUsuario(int idUsuario)// validacion de usuario
        {
            try
            {//conecxion a la base de datos 
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("sp_VU", con);// ejecuta un procedimiento al,alamacenado
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@idUsuario", idUsuario);// añade parametro de id usuario
        ...
        {
            try
            {//codigo aleatorio para el usuario
        ...
        //verificacionde codigo ingresado por el usuario
